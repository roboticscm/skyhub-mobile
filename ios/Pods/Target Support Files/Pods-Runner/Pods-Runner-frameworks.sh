...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_incall_manager/flutter_incall_manager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_local_notifications/flutter_local_notifications.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_money_formatter/flutter_money_formatter.framework"
