...
class RegisterDevicesUI extends StatefulWidget {
  ...
  @override
  State<RegisterDevicesUI> createState() {
    GlobalParam.registerDevicesUIState = RegisterDevicesUIState();
    return GlobalParam.registerDevicesUIState;
  }
}

class RegisterDevicesUIState extends State<RegisterDevicesUI> {
  ...
  @override
  void didUpdateWidget(RegisterDevicesUI oldWidget) {
  ...
  Widget _buildRecentChatList() {
    return Scaffold(
      ...
      appBar: _buildAppBar(L10n.of(context).device,  0),
      body: ListView (
  ...
  Widget _buildAppBar(String text, int numberOfNotifications) {
    return AppBar(
      ...
      title: Row(children: <Widget>[
        IconButton(
          icon: ClipOval(
            child: SvgPicture.asset('assets/setting.svg', color: STextStyle.PRIMARY_TEXT_COLOR),
          ),
          onPressed: (){
