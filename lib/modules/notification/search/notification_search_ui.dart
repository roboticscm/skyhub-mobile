...
class NotificationSearchUI extends StatefulWidget {
  @override
  _NotificationSearchUIState createState() => _NotificationSearchUIState();
}

class _NotificationSearchUIState extends State<NotificationSearchUI> {
  @override
