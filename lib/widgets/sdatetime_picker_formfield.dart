...
enum SInputType { date, time, both }
...
class SDateTimePickerFormField extends FormField<DateTime> {
  /// The date/time picker dialogs to show.
  final SInputType inputType;
  ...
  SDateTimePickerFormField({
    Key key,
    @required this.format,
    this.inputType = SInputType.both,
    this.editable = true,
    this.onChanged,
...
class _DateTimePickerTextFormFieldState extends FormFieldState<DateTime> {
  ...
  @override
  SDateTimePickerFormField get widget => super.widget;
  ...
  Future<DateTime> getDateTimeInput(
    ...
    if (widget.inputType != SInputType.time) {
      ...
      if (date != null) {
        ...
        if (widget.inputType == SInputType.both) {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: widget.resetIcon == null
        ...
        suffix: showResetIcon
            ? IconButton(
          icon: Icon(widget.resetIcon, size: 16,),
          onPressed: () {
            widget.focusNode.unfocus();
            _previousValue = '';
  ...
  @override
  void didUpdateWidget(SDateTimePickerFormField oldWidget) {
