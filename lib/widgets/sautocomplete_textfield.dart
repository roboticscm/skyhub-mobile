...
class SAutoCompleteTextField<T> extends StatefulWidget {
  ...
  void clear() => autoCompleteTextFieldState.clear();

  void addSuggestion(T suggestion) =>
      autoCompleteTextFieldState.addSuggestion(suggestion);

  void removeSuggestion(T suggestion) =>
      autoCompleteTextFieldState.removeSuggestion(suggestion);

  void updateSuggestions(List<T> suggestions) =>
      autoCompleteTextFieldState.updateSuggestions(suggestions);

  void triggerSubmitted() => autoCompleteTextFieldState.triggerSubmitted();
  ...
  void updateDecoration(
      ...
      autoCompleteTextFieldState.updateDecoration(decoration, inputFormatters,
          textCapitalization, style, keyboardType, textInputAction);

  TextField get textField => autoCompleteTextFieldState.textField;

  static AutoCompleteTextFieldState autoCompleteTextFieldState;
  @override
  State<StatefulWidget> createState() {
      autoCompleteTextFieldState = new AutoCompleteTextFieldState<T>(
        suggestions,
        textChanged,
        textSubmitted,
        onFocusChanged,
        ...
        controller,
        focusNode);
      return autoCompleteTextFieldState;
  }
}

class AutoCompleteTextFieldState<T> extends State<SAutoCompleteTextField> {
...
class SimpleAutoCompleteTextField extends SAutoCompleteTextField<String> {
  final StringCallback textChanged, textSubmitted;
  final int minLength;
  final ValueSetter<bool> onFocusChanged;
  final TextEditingController controller;
