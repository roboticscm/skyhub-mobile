...
const double _kTextAndIconTabHeight = 52.0;
...
enum TabBarIndicatorSize {
  ...
  ///
  /// This value is used to align the tab's label, typically a [STab]
...
class TabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [STab] widgets.
  ///
  ...
  /// the indicator with the tab's text for [STab] widgets and all but the
  /// shortest [STab.text] values.
  ///
